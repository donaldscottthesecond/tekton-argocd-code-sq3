...
class GroceryList extends Component {
  constructor(props) {
    ...
    const data = [
      [
        { label: "Grocery Item", value: "Bread", type: "textinput" },
        { label: "Quantity", value: "3", type: "textinput" },
        { label: "Unit", value: unitValues, type: "dropdown" },
      ],
      [
        { label: "Grocery Item", value: "Egg", type: "textinput" },
        { label: "Quantity", value: "2", type: "textinput" },
        { label: "Unit", value: unitValues, type: "dropdown" },
      ],
      [
        { label: "Grocery Item", value: "Milk", type: "textinput" },
        { label: "Quantity", value: "1", type: "textinput" },
        { label: "Unit", value: unitValues, type: "dropdown" },
      ],
      [
        { label: "Grocery Item", value: "Milk", type: "textinput" },
        { label: "Quantity", value: "5", type: "textinput" },
        { label: "Unit", value: unitValues, type: "dropdown" },
      ]
    ];
    this.state = {
